...
BOOL CreateRemoteThread_Injection()
{
	/* Some vars */
	DWORD dwProcessId;
	HANDLE hProcess = nullptr, hRemoteThread = nullptr;
	HMODULE hKernel32;
	...
	hRemoteThread = CreateRemoteThread(hProcess, nullptr, 0, (LPTHREAD_START_ROUTINE)LoadLibraryAddress, lpBaseAddress, NULL, nullptr);
